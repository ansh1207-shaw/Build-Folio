    ...
    >
      ...
      >
        ...
        <div className="space-y-2 text-lg">
          <p>
            <span className="font-semibold">Phone:</span> +91 8981485767
          </p>
          <p>
            <span className="font-semibold">Email : anshshaw1979@gmail.com</span>
          </p>
          <p>
            <span className="font-semibold">
              <a
                href="https://github.com/ansh1207-shaw"
                target="_blank"
